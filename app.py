...
updated_va.to_csv(DATA_FILE_QM, sep=";", index=False, encoding="utf-8-sig") st.success(f"Verfahrensanweisung {va_nr} gespeichert.")
#		
#	Anzeige & Export
#		
...
st.error(f"Interner Fehler: PDF-Daten sind kein Bytes-Objekt (Typ: {type(pdf_bytes)})") else:
st.download_button(
label="Download PDF",
data=pdf_bytes,
